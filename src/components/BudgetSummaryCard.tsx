    ...
    <div className="rounded-lg border border-neutral-800 bg-neutral-950 p-4 space-y-3">
      <div className="flex items-center justify-between border-b border-neutral-800 pb-2.5">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h4 className="text-xs font-semibold text-white">Resumo Orçamental Estimado</h4>
            <span className="text-[10px] text-neutral-400">Consolidação de Custos Previstos</span>
          </div>
        </div>

        <div>
          {budget.is_under_budget ? (
            <span className="inline-flex items-center space-x-1.5 text-neutral-200 text-xs font-medium">
              <CheckCircle2 className="w-3.5 h-3.5 text-white" />
              <span>Dentro do Orçamento</span>
            </span>
          ) : (
            <span className="inline-flex items-center space-x-1.5 text-neutral-400 text-xs font-medium">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs">
        <div className="p-2.5 rounded bg-black border border-neutral-800 space-y-0.5">
      ...
      <div className="pt-2.5 border-t border-neutral-800 flex items-center justify-between">
        <span className="text-xs font-medium text-neutral-300">Custo Total Estimado</span>
