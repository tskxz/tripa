    ...
    <div className="rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 p-4 space-y-3 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
      <div className="flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 pb-2.5">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h4 className="text-xs font-semibold text-black dark:text-white">{flight.airline}</h4>
            <span className="text-[10px] text-neutral-500 dark:text-neutral-400">Voo Recomendado</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-5 items-center text-xs">
        <div className="col-span-2 space-y-0.5">
          ...
          <span className="font-semibold text-neutral-800 dark:text-neutral-200 block truncate">{flight.departure.airport}</span>
        </div>
        ...
        <div className="col-span-2 text-right space-y-0.5">
          ...
          <span className="font-semibold text-neutral-800 dark:text-neutral-200 block truncate">{flight.arrival.airport}</span>
        </div>
      </div>

      <div className="pt-2 border-t border-neutral-200 dark:border-neutral-800/80 flex items-center justify-between text-xs">
        <div className="flex items-center space-x-1 text-neutral-500 dark:text-neutral-400 text-[11px]">
